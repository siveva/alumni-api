...
import { countUnapprovedUsers, deleteUser, getAllUsers, getUserByid, updateUser, userApproved } from "../services/auth.service";
...
userRoute.get("/pending/list", async (_req, res) => {
    try {
       const user = await countUnapprovedUsers();
